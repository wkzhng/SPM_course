...
title.className="num_list";title.appendChild(span);alpha(title,70);id.className="d1";div.className="d2";id.appendChild(div);id.appendChild(title);id.appendChild(button);
//渐显
