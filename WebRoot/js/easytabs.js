...
// Set the Number of the Menu which should autochange (if you dont't want to
// have a change menu set it to 0)
var autochangemenu = 1;
// the speed in seconds when the tabs should change
var changespeed = 3;
// should the autochange stop if the user hover over a tab from the
// autochangemenu? 0=no 1=yes
var stoponhover = 0;
// END MENU SETTINGS
